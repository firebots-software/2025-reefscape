...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    //     .rightBumper()
    //     .onTrue(
    //         new SetElevatorLevel(elevatorSubsystem, ElevatorPositions.safePosition)); // reset
    // mode
    ...
    // // This triggers when there is a Coral in the funnel ready to be transferred to Tootsie
    // Slide.
    ...
    // Position (L1).
    // coralInElevator.onTrue(new SetElevatorLevel(elevatorSubsystem,
    // ElevatorPositions.safePosition));
