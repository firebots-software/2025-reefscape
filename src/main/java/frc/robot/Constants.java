...
public final class Constants {
  ...
  public static class Swerve {
    ...
    public static double TELE_DRIVE_MAX_ACCELERATION_UNITS_PER_SECOND =
        6.01420; // im sorry for making this not constant
    public static final double CONST_TELE_DRIVE_MAX_ACCELERATION_UNITS_PER_SECOND_ELEVATOR_INTAKE =
        6.01420; // TODO: change these to be accurate
    public static final double CONST_TELE_DRIVE_MAX_ACCELERATION_UNITS_PER_SECOND_ELEVATOR_L1 =
        6.01420;
    public static final double CONST_TELE_DRIVE_MAX_ACCELERATION_UNITS_PER_SECOND_ELEVATOR_L2 =
        6.01420;
    public static final double CONST_TELE_DRIVE_MAX_ACCELERATION_UNITS_PER_SECOND_ELEVATOR_L3 =
        6.01420;
    public static final double CONST_TELE_DRIVE_MAX_ACCELERATION_UNITS_PER_SECOND_ELEVATOR_L4 =
        6.01420;
