...
public class AutoRedLeaveOnly extends SequentialCommandGroup {
  ...
  public AutoRedLeaveOnly(
    ...
    addCommands(
        new InstantCommand(
            () -> driveTrain.resetPose(Constants.Landmarks.redMidAutoStart)), new JamesHardenMovement(driveTrain, new Pose2d(
      new Translation2d(11.441716194152832, 4.050836891), new Rotation2d()), false));
  }
}