...
public class AutoBlueLeaveOnly extends SequentialCommandGroup {
  ...
  public AutoBlueLeaveOnly(
    ...
    addCommands(
        new InstantCommand(
            () -> driveTrain.resetPose(Constants.Landmarks.blueMidAutoStart)), new JamesHardenMovement(driveTrain, new Pose2d(
      new Translation2d(6.11305570602417, 4.050836891), new Rotation2d(Math.PI)), false));
  }
}
