...
public class VisionSystem extends SubsystemBase {
  ...
  public static VisionSystem getInstance(Constants.Vision.Cameras name) {
    if(systemList[name.ordinal()] == null){
      systemList[0] = new VisionSystem(Constants.Vision.Cameras.FRONT_CAM.toString(), Constants.Vision.Cameras.FRONT_CAM.ordinal());
      systemList[1] = new VisionSystem(Constants.Vision.Cameras.FRONT_CAM.toString(), Constants.Vision.Cameras.FRONT_CAM.ordinal());
    }
