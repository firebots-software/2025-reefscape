...
public class PathGenerator {
    ...
    private static Transform2d makeMagnitude(Transform2d transform, double magnitude) {
        return new Transform2d(transform.getX() * magnitude / magnitudeOfTransform2D(transform), transform.getY() * magnitude / magnitudeOfTransform2D(transform), transform.getRotation());
    }
}
