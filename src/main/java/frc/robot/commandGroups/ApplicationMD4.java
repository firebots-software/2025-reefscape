    ...
    addCommands(
        new SequentialCommandGroup(
            ...
            new SetElevatorLevel(
                elevator,
                ElevatorConstants.ElevatorPositions.L4,
                new isCoralInTootsieSlide().isFinished()),
            new SetElevatorLevel(
                elevator,
                ElevatorConstants.ElevatorPositions.L2,
                new isCoralInTootsieSlide().isFinished()),
            new SetElevatorLevel(
                elevator,
                ElevatorConstants.ElevatorPositions.L3,
                new isCoralInTootsieSlide().isFinished()),
            new SetElevatorLevel(
                elevator,
                ElevatorConstants.ElevatorPositions.L2,
            ...
            new ParallelCommandGroup(
                new SetElevatorLevel(
                    ...
                    new isCoralInTootsieSlide().isFinished()),
                new ParallelCommandGroup(
                    new ShootTootsieSlide(shooter),
                    new RunFunnelOutCommand(funnel, () -> false)))));
  }
}
