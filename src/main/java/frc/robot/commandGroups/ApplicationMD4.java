...
public class ApplicationMD4 extends SequentialCommandGroup{
    public ApplicationMD4(ElevatorSubsystem elevatorSubsystem, FunnelSubsystem funnelSubsystem, TootsieSlideSubsystem tootsieSlideSubsystem, LedSubsystem ledSubsystem, boolean checkIfCoralInTootsie){
        addCommands(
            new SequentialCommandGroup(
            new Intake(elevatorSubsystem, funnelSubsystem, tootsieSlideSubsystem, ledSubsystem),
            new SetElevatorLevel(elevatorSubsystem, ElevatorConstants.ElevatorPositions.L4, new isCoralInTootsieSlide.isFinished()), 
            ...
            new SetElevatorLevel(elevatorSubsystem, ELevatorConstants.ElevatorPositions.L2, new isCoralInTootsieSlide.isFinished()), 
            new ShootTootsieSlide(tootsieSlideSubsystem).alongwith(new RunFunnelOutCommand(funnelSubsystem, () -> false))
            new ParallelDeadlineGroup(new ShootTootsieSlide(TootsieSlideSubsystem), package frc.robot.commandGroups;
