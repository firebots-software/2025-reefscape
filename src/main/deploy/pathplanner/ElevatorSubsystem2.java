...
public class ElevatorSubsystem2 extends SubsystemBase {
    private LoggedTalonFX motor1; //initializing motors, setting master variable & target height
    ...
    motor2 =
        ...
        Follower follower = new Follower(ElevatorConstants.MOTOR1_PORT, false); //set follower to motor 2
        motor2.setControl(follower);

        //PID configs, slot 0 & 1
        Slot1Configs s1c =
        new Slot1Configs()
        ...
        //set master to motor1
        master = motor1;
    }

    public void setPosition(double height) {
        if (height < Constants.ElevatorConstants.minHeight) height = Constants.ElevatorConstants.minHeight; //min height of elevator to min height in constants
        if (height > Constants.ElevatorConstants.maxHeight) height = Constants.ElevatorConstants.maxHeight; //max height of elevator to max height in constants
